...
;
; PROCEDURE:
;     Just read the Spextool FITS file and write it to disk.
;
; EXAMPLE:
;     IDL> spex2text,'spectra0001.fits'
;     IDL> spex2text,'spectra*.fits'
;
...
;     2017-12-02 - removed the mc_cfile check to allow for multiple files.
;-
