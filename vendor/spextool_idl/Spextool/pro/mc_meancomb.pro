...
;  Set up the Fanning showprogress object if requested.
  ...
  if keyword_set(UPDATE) and keyword_set(WIDGET_ID) and sigmaclip then begin

     progressbar = obj_new('SHOWPROGRESS',widget_id,COLOR=2,$
                           /CANCELBUTTON,MESSAGE='  Identifying outliers...')
     progressbar -> start
     ...
     if sigmaclip then begin
        ...
        for i = 0,ncols-1 do begin
           ...
           if keyword_set(UPDATE) then begin
              ...
              endif else mc_loopprogress,i,0,ncols-1
