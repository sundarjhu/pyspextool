...
;
; CALLING SEQUENCE:
;     result = mc_mkapmask(slit,positions,apradius,PSBGINFO=bginfo,$
...
;                   routine.
;-
function mc_mkapmask,slit,positions,apradius,PSBGINFO=psbginfo,$
                     XSBGINFO=xsbginfo,WIDGET_ID=widget_id,$
                     CANCEL=cancel
  ...
  if n_params() lt 3 then begin
     ...
     print, 'Syntax - result = mc_mkapmask(slit,positions,apradius,$'
     print, '                              PSBGINFO=bginfo,XSBGINFO=xsbginfo,$'
     print, '                              WIDGET_ID=widget_id,CANCEL=cancel)'
     cancel = 1
     return, -1
     
  endif
  cancel = mc_cpar('mc_mkapmask',slit,1,'Slit',[2,3,4,5],1)
  if cancel then return, -1
  cancel = mc_cpar('mc_mkapmask',positions,2,'Positions',[2,3,4,5],[0,1])
  if cancel then return, -1
  cancel = mc_cpar('mc_mkapmask',apradius,3,'Apradius',[2,3,4,5],[0,1])
  if cancel then return, -1
