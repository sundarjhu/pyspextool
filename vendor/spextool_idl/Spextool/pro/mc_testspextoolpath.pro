...
;  Check Spextool path
  ...
  file = file_which('cgset.pro')

  if file eq '' then begin

     cancel = 1
     print
     print, "The coyote extension directories are not in your IDL path."
     return

  endif else begin

     print
     print, "The coyote extension directories are in your IDL path."
  ...
  if file eq '' then begin
     ...
     cancel = 1
     print
     print,"The Markwardt CMTOTAL Library directories are not in your IDL path."
     return

  endif else begin

     print
     print, "The Markwardt CMTOTAL Library directories are in your IDL path."
