...
;
; CALLING SEQUENCE:
;     result = mc_poly1d(x,coeffs,[coeffs_var],YVAR=yvar,CANCEL=cancel)
;
; INPUTS:
...
;                  covariance matrix.
;     2017-10-07 - Renamed mc_poly1d
;-
function mc_poly1d,x,coeffs,coeffs_var,YVAR=yvar,CANCEL=cancel
...
;  Check parameters
  ...
  if n_params() lt 2 then begin
     ...
     cancel = 1
     print, 'Syntax -  result = mc_poly1d(x,coeffs,coeffs_var,YVAR=yvar,$'
     print, '                             CANCEL=cancel)'
     return, -1
     
  endif
  cancel = mc_cpar('mc_poly1d',x,1,'X',[2,3,4,5],[0,1])
  if cancel then return,-1
  cancel = mc_cpar('mc_poly1d',coeffs,2,'Coeffs',[2,3,4,5],[0,1])
  if cancel then return,-1
